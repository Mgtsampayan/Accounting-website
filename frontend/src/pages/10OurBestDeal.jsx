...
function OurBestDeal() {
    const services = ['Bookkeeping', 'Financial Statement Reporting'];
                ...
                >
                    <div className="relative z-10 w-full max-w-full xl:max-w-[1920px] grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-20 items-center">
                        ...
                        >
                            ...
                            >
                                <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold">$500/MONTH</span>
                                <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mt-2">Introductory price for new clients</p>
                            </motion.div>
                            <motion.div
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
...
export default React.memo(OurBestDeal);